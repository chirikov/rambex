...
$body="@day7@ [F]@month3@, [F]@day@"; #шаблоны даты
...
if (!$time)
{
$manlix_russian_time = "¬ы не указали врем€ дл€ получени€ дн€ недели";
}
else if (!is_numeric($time))
{
$manlix_russian_time = "¬ы указали некорректное врем€ дл€ получени€ дн€ недели";
}
else
{
